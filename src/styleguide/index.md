...
<div class="row up-1 medium-up-3 large-up-5">
  ...
  <div class="column">
    <div class="color-block">
      <span style="background: #5ec2b7"></span>
      #5ec2b7
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #303633"></span>
      #303633
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #ff220c"></span>
      #ff220c
    </div>
  </div>
  <div class="column">
    <div class="color-block">
      <span style="background: #0e0b08"></span>
      #0e0b08
    </div>
  </div>
</div>
...
<p class="lead">This design uses Open Sans for headings and Gentium Basic for paragraph text.</p>
